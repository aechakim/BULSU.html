...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    <a href="#"><img src="p.jpg" style="width:65px;" class="w3-circle w3-right w3-margin w3-hide-large w3-hover-opacity"></a>
  ...
  <div class="w3-row-padding">
    <div class="w3-third w3-container w3-margin-bottom">
      <img src="maizo.jpg" alt="Norway" style="width:100%" class="w3-hover-opacity">
    ...
    <div class="w3-third w3-container w3-margin-bottom">
      <img src="cenabre.jpg" alt="Norway" style="width:100%" class="w3-hover-opacity">
      <div class="w3-container w3-white">
    ...
    <div class="w3-third w3-container">
      <img src="ian.jpg" alt="Norway" style="width:100%" class="w3-hover-opacity">
      <div class="w3-container w3-white">
  ...
  <div class="w3-row-padding">
    <div class="w3-third w3-container w3-margin-bottom">
      <img src="quiros.png" alt="Norway" style="width:100%" class="w3-hover-opacity">
      <div class="w3-container w3-white">
    ...
    <div class="w3-third w3-container w3-margin-bottom">
      <img src="bacolor.jpg" alt="Norway" style="width:100%" class="w3-hover-opacity">
      <div class="w3-container w3-white">
    ...
    <div class="w3-third w3-container">
      <img src="icasiano.jpg" alt="Norway" style="width:100%" class="w3-hover-opacity">
      <div class="w3-container w3-white">
        ...
        <img src="andrei.jpg" alt="Norway" style="width:100%">
        <div class="w3-container w3-white">
